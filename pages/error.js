        ...
        <div className="container">
          <div className="row">
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z"/>
                    <g id="antenna">
                      <line fill="#FFFFFF" stroke="#0E0620"
                            x1="323.396" y1="236.625" x2="295.285" y2="353.753"/>
                      <circle fill="#FFFFFF" stroke="#0E0620"
            ...
            <div className="col-md-6 align-self-center">
              <h1>You're lost.</h1>
              {/*<h2>You're lost.</h2>*/}
              <p>So sorry. Something went wrong and we lost you in space, but we can save you. Just click the button and go back us.
              </p>
              <Link href="/">
